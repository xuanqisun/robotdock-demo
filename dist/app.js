'use strict';
const bundles = {
  base: { title: '小背包标准版', description: '适合已有末端设备、希望自行拓展的开发团队。', items: ['背包主机', '基础软件与说明', '本体连接线束'] },
  hand: { title: '小背包 + 灵巧手套装', description: '面向灵巧操作、科研与数据采集；灵巧手品牌和型号待选定。', items: ['背包主机', '指定灵巧手（待选型）', '设备专用线束', '手腕安装件', '对应驱动与安装说明'] },
  gripper: { title: '小背包 + 智元夹爪套装', description: '基于团队已有接入成果，规划形成完整抓取套装。夹爪型号待确认。', items: ['背包主机', '智元夹爪（型号待确认）', '设备专用线束', '手腕安装件', '对应驱动与安装说明'] }
};
const views = {
